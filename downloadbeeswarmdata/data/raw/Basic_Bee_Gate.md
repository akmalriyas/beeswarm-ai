...
[ ![5819DB6E-0C21-4C7E-83BE-A5A197D5FBA0](https://static.wikia.nocookie.net/bee-swarm-simulator/images/9/96/5819DB6E-0C21-4C7E-83BE-A5A197D5FBA0.jpeg/revision/latest/scale-to-width-down/268?cb=20180831134909) ](https://static.wikia.nocookie.net/bee-swarm-simulator/images/9/96/5819DB6E-0C21-4C7E-83BE-A5A197D5FBA0.jpeg/revision/latest?cb=20180831134909 "5819DB6E-0C21-4C7E-83BE-A5A197D5FBA0") The Basic Bee Gate.

### Mobs

  * 1 [Spider](/wiki/Spider "Spider").
  * 2 [Rhino Beetles](/wiki/Rhino_Beetle "Rhino Beetle").
  * 2 [Ladybugs](/wiki/Ladybug "Ladybug").



### Quest Givers

  * [Panda Bear](/wiki/Panda_Bear "Panda Bear").



### Shops

  * [Gumdrop Shop](/wiki/Gumdrop_Shop "Gumdrop Shop").
...
### Extras
  ...
  * [Brave Bee Gate](/wiki/Brave_Bee_Gate "Brave Bee Gate").
  * [Honey Bee Gate](/wiki/Honey_Bee_Gate "Honey Bee Gate").
  * [Global Top Battlers Leaderboard](/wiki/Global_Top_Battlers_Leaderboard "Global Top Battlers Leaderboard").
  * [Vicious Bee Egg Claim](/wiki/Vicious_Bee_Egg_Claim "Vicious Bee Egg Claim").
  * [Moon Amulet Generator](/wiki/Moon_Amulet_Generator "Moon Amulet Generator").
  * [Bamboo Field Obby](/wiki/Obstacle_Courses#Bamboo_Field_Obby "Obstacle Courses").



The **Basic Bee Gate** , also called the **5 Bee Gate** , is the first [gate](/wiki/Category:Gates "Category:Gates") a player is tasked with unlocking. The gate requires you to own 5 [bees](/wiki/Bees "Bees") or more to pass through. 

It gets its name from the large [Basic Bee](/wiki/Basic_Bee "Basic Bee") that's on top of it. 

The audio known as "[bpatrol](/wiki/Music "Music")" plays in the daytime while you are past this gate. 

  


## Trivia[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FBasic_Bee_Gate%3Fveaction%3Dedit%26section%3D1&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

  * This is the only gate to have more than one gate directly leading from it, with those being the [Brave Bee Gate](/wiki/Brave_Bee_Gate "Brave Bee Gate") and the [Honey Bee Gate](/wiki/Honey_Bee_Gate "Honey Bee Gate").
  * This gate requires the least amount of bees to pass through.
  * This and the [Ant Gate](/wiki/Ant_Gate "Ant Gate") are the only gates that lead to a zone where there is nothing that can be purchased with [Honey](/wiki/Honey "Honey").
  * [Bubble Bee Man](/wiki/Bubble_Bee_Man "Bubble Bee Man") used to be behind the [Global Top Battlers](/wiki/Global_Top_Battlers "Global Top Battlers") leaderboard. However, he was removed after Beesmas 2018.
  * Before the [2020-06-06 update](/wiki/Updates#2020-06-06 "Updates"), [Honey Bee](/wiki/Honey_Bee_\(NPC\) "Honey Bee \(NPC\)") was located next to the ramp.
  * Underneath the ramp, on the side facing the [Blue HQ](/wiki/Blue_HQ "Blue HQ"), there is a [ticket](/wiki/Ticket "Ticket") token, previously a [Plastic Egg](/wiki/Plastic_Egg "Plastic Egg").
  * Due to a glitch, the [Onett statue](/wiki/Easter_Eggs#Onett_NPC "Easter Eggs"), located near the hives could have been seen near this gate. This glitch is now patched.
  * This gate is the only gate that cannot have a [Wild Windy Bee](/wiki/Wild_Windy_Bee "Wild Windy Bee") spawn in any of its fields (without the assistance of [Onett](/wiki/Onett_\(Developer\) "Onett \(Developer\)"), during Beesmas or flying there from another field) (not counting the [Ant Gate](/wiki/Ant_Gate "Ant Gate") as it has only a challenge field or [Bear Gate](/wiki/Bear_Gate "Bear Gate") as the Bear Gate does not have any fields).
  * This gate is the only gate that doesn't teleport you back to the spawn point if you don't have the required bees.
...
[![The Basic Bee on top of the gate with a Santa hat on during Beesmas.](https://static.wikia.nocookie.net/bee-swarm-simulator/images/d/d9/BasicGateXmas.png/revision/latest/scale-to-width-down/180?cb=20211231135637)](https://static.wikia.nocookie.net/bee-swarm-simulator/images/d/d9/BasicGateXmas.png/revision/latest?cb=20211231135637) [](/wiki/File:BasicGateXmas.png)
...
[Gates](/wiki/Category:Gates "Category:Gates") | ****Basic Bee Gate** • [Brave Bee Gate](/wiki/Brave_Bee_Gate "Brave Bee Gate") • [Honey Bee Gate](/wiki/Honey_Bee_Gate "Honey Bee Gate") • [Ant Gate](/wiki/Ant_Gate "Ant Gate") • [Lion Bee Gate](/wiki/Lion_Bee_Gate "Lion Bee Gate") • [Bear Gate](/wiki/Bear_Gate "Bear Gate") • [Windy Bee Gate](/wiki/Windy_Bee_Gate "Windy Bee Gate")**  
