...
![Looker Bee](https://static.wikia.nocookie.net/bee-swarm-simulator/images/5/5d/Looker_Bee.png/revision/latest/scale-to-width-down/100?cb=20200403235630) | **This article should be regularly looked at for new changes.** Please regularly update the status of the All-Time Fastest Crab Slayers article with date of change. (Recommended once per week.)  
---|---  
  
  
_(Leaderboard as of 2026-01-29)_

All-Time Fastest Crab Slayers   
---  
**1:** | **5_Gummy** | **1.25 Seconds**  
**2:** | **buhloonx2** | **1.5 Seconds**  
**3:** | **HeroVsMuffin** | **1.5 Seconds**  
**4:** | **janeX1707** | **1.5 Seconds**  
**5:** | **AntisZx** | **2 Seconds**  
**6:** | **WillydaleBSS** | **2.25 Seconds**  
**7:** | **HavingFun2228** | **2.375 Seconds**  
**8:** | **BowToDaFob** | **2.5 Seconds**  
**9:** | **stingerabbasiii** | **2.5 Seconds**  
**10:** | **Cawuoo** | **3.125 Seconds**  
**Page last updated on 01/29/2026** __  
  
  
The **Fastest Crab Slayers** is one of the 64 [leaderboards](/wiki/Leaderboards "Leaderboards") in the game. This leaderboard shows the least time in which the player has defeated the [Coconut Crab](/wiki/Coconut_Crab "Coconut Crab"). It shows 10 leaderboard positions at one time. The player can scroll down the leaderboard to see more players, all the way to the 100th place. 

If the player has never defeated the Coconut Crab the pad will prompt, "You haven't defeated the Coconut Crab". 

## Location[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FAll-Time_Fastest_Crab_Slayers%3Fveaction%3Dedit%26section%3D1&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

It is located past the [Windy Bee Gate](/wiki/Windy_Bee_Gate "Windy Bee Gate") inside the [Coconut Cave](/wiki/Coconut_Cave "Coconut Cave"). The player will need to defeat the Coconut Crab to enter the Cave and see their score. 

## Achievements[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FAll-Time_Fastest_Crab_Slayers%3Fveaction%3Dedit%26section%3D2&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]
  ...
  * Miracle_Mike was the first user to defeat the Coconut Crab in 15 seconds or less.
  * e_IoI was the first user to defeat the Coconut Crab in 10 seconds or less.
...
## Trivia[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FAll-Time_Fastest_Crab_Slayers%3Fveaction%3Dedit%26section%3D3&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

  * This is the first and only [leaderboard](/wiki/Category:Leaderboards "Category:Leaderboards") to rank by time (time before defeated). 
    * This leaderboard, the [Highest Snowbear Level](/wiki/Highest_Snowbear_Level "Highest Snowbear Level") leaderboard, and the [Top Stick Bug Fighters](/wiki/Top_Stick_Bug_Fighters "Top Stick Bug Fighters") leaderboard are the only three leaderboards to rank "[bosses](/wiki/Category:Bosses "Category:Bosses")".
    * This is the only leaderboard for the shortest amount of time to accomplish a goal.
  * This leaderboard is currently updated and has been repolished.
  * Onett accidentally put Coconut Crab's Health to only 20 and fixed it later, in the duration of the oversight, many players were able to reach faster times than usual. The leaderboard was later reset in June 2024.
