...
[![Mixed Brick Field](https://static.wikia.nocookie.net/bee-swarm-simulator/images/0/01/Mixed_Brick_Field.png/revision/latest/scale-to-width-down/275?cb=20250724191159)](https://static.wikia.nocookie.net/bee-swarm-simulator/images/0/01/Mixed_Brick_Field.png/revision/latest?cb=20250724191159)
...
The **Mixed Brick Field** is one of the four [fields](/wiki/Fields "Fields") located in the [Retro Swarm Challenge](/wiki/Retro_Swarm_Challenge "Retro Swarm Challenge"). 

This is a 19x19 field, containing 361 [flowers](/wiki/Flowers "Flowers"). The flowers are white, blue, and red, in sizes of single, double, and triple. 

This field can produce [brick](/wiki/Brick "Brick") tokens while collecting [pollen](/wiki/Pollen "Pollen"). 

There are no bees with any preference towards this field. 

Since [planters](/wiki/Planter "Planter") cannot be used in the Retro Swarm Challenge, there is no confirmed nectar type for this field. 
...
---|---|---|---|---  
Single | 30  | 8.33%  | 30  | 8.33%  | 30  | 8.33%  | **90** | **25%**  
Double | 60  | 16.67%  | 60  | 16.67%  | 60  | 16.67%  | **181** | **50%**  
Triple | 30  | 8.33%  | 30  | 8.33%  | 30  | 8.33%  | **90** | **25%**  
Total  | **120** | **33.33%** | **120** | **33.33%** | **120** | **33.33%** | **361** | **100%**  
...
## Obtaining Boosts[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FMixed_Brick_Field%3Fveaction%3Dedit%26section%3D1&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

  * Using ![Glitter](https://static.wikia.nocookie.net/bee-swarm-simulator/images/6/63/Glitter.png/revision/latest/scale-to-width-down/25?cb=20230404021017)[Glitter](/wiki/Glitter "Glitter") in the Mixed Brick Field will grant a 100% Mixed Brick Field pollen boost for 15 minutes.



## Gallery[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FMixed_Brick_Field%3Fveaction%3Dedit%26section%3D2&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

[![The Mixed Brick Field's associated boost icon.](https://static.wikia.nocookie.net/bee-swarm-simulator/images/a/a1/Sunflower_Field_Icon.png/revision/latest?cb=20230410080028)![The Mixed Brick Field's associated boost icon.](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)](/wiki/File:Sunflower_Field_Icon.png "Sunflower Field Icon.png \(6 KB\)")

The Mixed Brick Field's associated [boost icon](/wiki/Field_Boost "Field Boost").

## Trivia[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FMixed_Brick_Field%3Fveaction%3Dedit%26section%3D3&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]
  ...
  * This field and three other fields present in the Retro Swarm Challenge are the only fields without an associated field stamp. 
    * All of these fields also borrow the [Sunflower Field](/wiki/Sunflower_Field "Sunflower Field")'s boost icon.



Locations   
---  
[Fields](/wiki/Fields "Fields") | **[Sunflower Field](/wiki/Sunflower_Field "Sunflower Field") • [Dandelion Field](/wiki/Dandelion_Field "Dandelion Field") • [Mushroom Field](/wiki/Mushroom_Field "Mushroom Field") • [Blue Flower Field](/wiki/Blue_Flower_Field "Blue Flower Field") • [Clover Field](/wiki/Clover_Field "Clover Field") • [Spider Field](/wiki/Spider_Field "Spider Field") • [Bamboo Field](/wiki/Bamboo_Field "Bamboo Field") • [Strawberry Field](/wiki/Strawberry_Field "Strawberry Field") • [Pineapple Patch](/wiki/Pineapple_Patch "Pineapple Patch") • [Stump Field](/wiki/Stump_Field "Stump Field") • **Mixed Brick Field** • [Blue Brick Field](/wiki/Blue_Brick_Field "Blue Brick Field") • [Red Brick Field](/wiki/Red_Brick_Field "Red Brick Field") • [White Brick Field](/wiki/White_Brick_Field "White Brick Field") • [Cactus Field](/wiki/Cactus_Field "Cactus Field") • [Pumpkin Patch](/wiki/Pumpkin_Patch "Pumpkin Patch") • [Pine Tree Forest](/wiki/Pine_Tree_Forest "Pine Tree Forest") • [Rose Field](/wiki/Rose_Field "Rose Field") • [Ant Field](/wiki/Ant_Field "Ant Field") • [Hub Field](/wiki/Hub_Field "Hub Field") • [Mountain Top Field](/wiki/Mountain_Top_Field "Mountain Top Field") • [Coconut Field](/wiki/Coconut_Field "Coconut Field") • [Pepper Patch](/wiki/Pepper_Patch "Pepper Patch")**  
