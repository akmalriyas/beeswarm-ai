...
[ ![LionBeeGate](https://static.wikia.nocookie.net/bee-swarm-simulator/images/c/c3/LionBeeGate.png/revision/latest/scale-to-width-down/268?cb=20180421063328) ](https://static.wikia.nocookie.net/bee-swarm-simulator/images/c/c3/LionBeeGate.png/revision/latest?cb=20180421063328 "LionBeeGate") The Lion Bee Gate.
...
### Shops
  ...
  * [Mountain Top Shop](/wiki/Mountain_Top_Shop "Mountain Top Shop").
  * [Ticket Shop](/wiki/Ticket_Shop "Ticket Shop").
...
### Extras
  ...
  * [Bear Gate](/wiki/Bear_Gate "Bear Gate").
  * [Instant Converter](/wiki/Instant_Converter "Instant Converter").
  * [Field Booster](/wiki/Field_Booster "Field Booster").



The **Lion Bee Gate** , also known as the **Mountain Top Gate** or the **25 Bee Gate** , is a [gate](/wiki/Category:Gates "Category:Gates") that requires 25 [bees](/wiki/Bees "Bees") to pass through. It is located at the end of the slope beside the [Pumpkin Patch](/wiki/Pumpkin_Patch "Pumpkin Patch"). 

It gets its name from the large statue of a [Lion Bee](/wiki/Lion_Bee "Lion Bee") located on top of it. 

This area contains the [Mountain Top Field](/wiki/Mountain_Top_Field "Mountain Top Field"), [Mondo Chick](/wiki/Mondo_Chick "Mondo Chick"), [Sticker Printer](/wiki/Sticker_Printer "Sticker Printer"), [Field Booster](/wiki/Field_Booster "Field Booster"), [Instant Converter](/wiki/Instant_Converter "Instant Converter"), [Ticket Shop](/wiki/Ticket_Shop "Ticket Shop") and the [Mountain Top Shop](/wiki/Mountain_Top_Shop "Mountain Top Shop"). 

## Trivia[[](https://auth.fandom.com/signin?redirect=https%3A%2F%2Fbee-swarm-simulator.fandom.com%2Fwiki%2FLion_Bee_Gate%3Fveaction%3Dedit%26section%3D1&uselang=en&metadata=article-registration-edit-article-section "Sign in to edit")]

  * As of the [2019-09-28 update](/wiki/Updates#2019-09-28 "Updates"), the player will be teleported back to spawn if they manage to bypass the gate, whether if it was by jumping around it or using the [Red Cannon](/wiki/Red_Cannon "Red Cannon") without 25 bees.
  * This and the [Ant Gate](/wiki/Ant_Gate "Ant Gate") share a few similarities. 
    * They are the only gates that don't have a [quest giver](/wiki/Quest_Givers "Quest Givers") behind them. 
      * If one were to count the [Sticker-Seeker Quest Machine](/wiki/Sticker-Seeker_Quest_Machine "Sticker-Seeker Quest Machine") inside the [Hive Hub Portal](/wiki/Hive_Hub "Hive Hub") past the Ant Gate, or [Gummy Bear](/wiki/Gummy_Bear "Gummy Bear"), then this would be the only gate that doesn't have a quest giver behind it.
    * They are the only gates that only contain 1 [field](/wiki/Fields "Fields"). 
      * If one were to count the [Hub Field](/wiki/Hub_Field "Hub Field") inside the [Hive Hub Portal](/wiki/Hive_Hub "Hive Hub") past the Ant Gate, then this would be the only gate that contains 1 field.
  * This used to be the final gate accessed in the game, until the Bear Gate was added in the [2018-7-11 update](/wiki/Updates "Updates").
...
[Gates](/wiki/Category:Gates "Category:Gates") | **[Basic Bee Gate](/wiki/Basic_Bee_Gate "Basic Bee Gate") • [Brave Bee Gate](/wiki/Brave_Bee_Gate "Brave Bee Gate") • [Honey Bee Gate](/wiki/Honey_Bee_Gate "Honey Bee Gate") • [Ant Gate](/wiki/Ant_Gate "Ant Gate") • **Lion Bee Gate** • [Bear Gate](/wiki/Bear_Gate "Bear Gate") • [Windy Bee Gate](/wiki/Windy_Bee_Gate "Windy Bee Gate")**  
